...
def enrich(url):
    ...
    processed_data_ws = df_world_population.to_csv('../data/processed/processed_data_ws.csv', index=False)
    df_forbes = pd.read_csv('../data/processed/processed_data.csv')
    df_wikipedia = pd.read_csv('../data/processed/processed_data_ws.csv')
